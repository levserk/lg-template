...
contexts['loader']['loaderOf'] = "Out of";
...
contexts['gameList']['sortByWonCountHint'] = "Sort by<br />number of winners";
contexts['gameList']['sortByPlayedCountHint'] = "Sort by<br />number of players";
...
contexts['history']['noGamesAlert'] = "Your history contains no games";
...
contexts['history']['pokeSolutionShortLabel'] = "see sol-n";//DELETE
...
contexts['rating'] = [];
contexts['rating']['placeLabel'] = "Rank";
...
contexts['profile'] = [];
contexts['profile']['sideActivityHeader'] = "This username on other computers";//DELETE
...
contexts['profile']['msgTextLabel'] = "Text of the latest message";
...
contexts['profile']['emptyMsgAlert'] = "Message cannot be blank";
contexts['profile']['sendPMHeader'] = "Send private message";
contexts['profile']['selectRecipientsButtonLabel'] = "Choose message recipients";//DELETE
contexts['profile']['sendMsgButtonLabel'] = "Send message";
contexts['profile']['noRecipientAlert'] = "You must choose at least one recipient";//DELETE
...
contexts['bonus'] = [];
contexts['bonus']['fastestBonus'] = "You have solved this hand faster than anyone.";
...
contexts['bonus']['winTimeRankLabel'] = "Rank by solution time ";
contexts['bonus']['bestAttemptBonus'] = "This attempt had the best time.";
contexts['bonus']['betterAttemptBonus'] = "You have improved on your best attempt time.";
...
contexts['bonus']['rangeFromPrepositionAlpha'] = "from";
contexts['bonus']['rangeFromPrepositionBeta'] = "from";
contexts['bonus']['bestAttemptRankChangeNotice'] = "<p>You have gone up in the best<br />"
    + "attempt rank {{2}} {{0}} to {{1}} position.</p>";
contexts['bonus']['ratingRankChangeNotice'] = "<p style='margin-top: 15px;'>You have gone up in the rating "
    + " {{2}} {{0}} to {{1}} position.</p>";
...
contexts['guestBook']['header'] = "Guestbook";
...
contexts['loginRegister']['loginPasswdNoMatchNotice'] = "The entered username/password combination was not found.";
contexts['loginRegister']['minUsernameLengthNotice'] = "Name must be at least 3 characters long.";
contexts['loginRegister']['maxUsernameLengthNotice'] = "Maximum length is 25 characters.";
contexts['loginRegister']['minPasswdLengthNotice'] = "Password must be at least 5 characters long.";
contexts['loginRegister']['maxPasswdLengthNotice'] = "Maximum username length is 25 characters.";
contexts['loginRegister']['passwdsDontMatchNotice'] = "The passwords<br>do not match.";
contexts['loginRegister']['passwdsDoMatchNotice'] = "Passwords match.";
contexts['loginRegister']['usernameTakenNotice'] = "This username is already taken.";
contexts['loginRegister']['usernameAvailableNotice'] = "This username is available.";
contexts['loginRegister']['usernameRequiredNotice'] = "You have not specified a username.";
...
contexts['ui']['forUsersOnlyNotice'] = "To use this feature you must first register and/or sign in.";
...
contexts['kosynka'] = [];
contexts['kosynka']['deckContainsDuplicatesError'] = "Game cannot be started: the deck contains duplicates";
contexts['kosynka']['deckWrongCardCountError'] = "The game cannot be started: the number of cards in the deck is not 52";
...
contexts['ui']['stepbystep'] = "Show in motion"
...
contexts['ui']['color'] = "Colored"
contexts['ui']['color2'] = "Color"
contexts['ui']['active_color'] = "Only movable figures colored"
contexts['ui']['gray'] = "One color"
...
contexts['ui']['savegame'] = "Save current game?"
...
contexts['g_game']['rival_miss_move'] = "Your turn, opponent has missed his turn";
...
contexts['g_message']['training'] = "Free mode";
...
contexts['g_message']['takeback_option0'] = ", with a right to move backwards <b>without opponent's consent</b>";
contexts['g_message']['takeback_option1'] = ", with a right to move backwards <b>with opponent's consent</b>";
contexts['g_message']['gamemode0'] = "Tic-tac-toe";
contexts['g_message']['gamemode1'] = "<span style='color:#069;'>Renju</span>";
contexts['g_message']['takeback_request'] = " wants to take back the move. Allow?";
...
contexts['g_message']['spectate_leave_0'] = "You left Spectator mode";
contexts['g_message']['surrended_0'] = "surrended";
contexts['g_message']['win_0'] = ", you won.";
contexts['g_message']['lose_0'] = ", you lost.";
contexts['g_message']['you_inactive_minute'] = "Out of game for 1 minute";//DELETE
contexts['g_message']['rival_inactive_minute'] = "Opponent inactive last 1 minute";//DELETE
...
contexts['g_message']['lose_if_exit'] = " You will be defeated in current game";
...
contexts['g_message']['server_update'] = "Technical works underway , new games temporarily unavailable";
contexts['g_message']['history_mode'] = "History in ";


contexts['g_chat'] = [];//DELETE g_chat
...
contexts['g_chat']['message_bad_words'] = "Using profanity and abusive language is prohibited in the chat";
...
contexts['g_pl']['rating_no_rank'] = "not present in the rating";
...
contexts['g_pl']['invite_waiting_limit'] = "has exceeded the waiting limit by";
...
contexts['g_rating']['games_win'] = "Beat his opponents";
contexts['g_rating']['games_win_percent'] = "%";
contexts['g_rating']['games_win_comp'] = "Beat the computer";
...
contexts['g_rating']['newbie'] = "novice";
...
contexts['g_rating']['title_sort_comp'] = "Sort by the number of times you beat the computer";
