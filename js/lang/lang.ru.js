...
contexts['gameList']['gameRatingDescription'] = 'среднее время решения игроками';
contexts['gameList']['winTimeAndRankLabel'] = 'Время решения /<br /> Ваше место';
...
contexts['gameList']['sortByWinTimeHint'] = "Сортировать по<br />времени Вашего решения";
...
contexts['history']['wtLabel'] = 'Время решения / Ваше место';
contexts['history']['baLabel'] = 'Время лучшей попытки / Ваше место';
...
contexts['history']['pokeSolutionShortLabel'] = "см. реш.";//DELETE
...
contexts['rating']['bestWinTimeCountLabel'] = "1-х мест<br />по<br />времени решения";
...
contexts['profile'] = [];
contexts['profile']['sideActivityHeader'] = "Это имя пользователя на других компьютерах";//DELETE
...
contexts['profile']['selectRecipientsButtonLabel'] = "Выбор получателей сообщения";//DELETE
contexts['profile']['sendMsgButtonLabel'] = "Отправить сообщение";
contexts['profile']['noRecipientAlert'] = "Вы не выбрали ни одного получателя.";//DELETE
...
contexts['controller']['rejectDealFromStock'] = "Нельзя сдать новый ряд, пока на столе есть пустые колонки.";
...
contexts['ui']['solutionLengthLabel'] = "длина";//DELETE
...
contexts['ui']['forUsersOnlyNotice'] = "Для использования этой возможности вам необходимо зарегистрироваться и/или выполнить вход.";
...
contexts['kosynka'] = [];
contexts['kosynka']['deckContainsDuplicatesError'] = "Игра не может быть создана: колода содержит дубли";//DELETE
contexts['kosynka']['deckWrongCardCountError'] = "Игра не может быть создана: в колоде отличное от 52 число карт";//DELETE
...
contexts['ui']['active_color'] = "Выделять активную фигуру"
...
contexts['g_message']['you_inactive_minute'] = "Вы не участвуете в игре в течение минуты";//DELETE
contexts['g_message']['rival_inactive_minute'] = "Соперник бездействует в течение минуты";//DELETE
...
contexts['g_rating']['title_close_rating'] = "Закрыть";
